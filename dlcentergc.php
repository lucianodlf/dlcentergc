...
if (in_array('-test', $argv)) {
	$users = [
		['Rafa', 0, 'luciano@datalabcenter.com'],	
		['Jose', 0, 'luciano@datalabcenter.com'],
		['Dario', 0, 'luciano@datalabcenter.com'],
		['Pedro', 0, 'luciano@datalabcenter.com'],
		['Luciano', 0, 'luciano@datalabcenter.com'],
		['Willian', 0, 'luciano@datalabcenter.com'],
	];
}else{
	$users = [
		['Rafa', 0, 'rfbomate86@gmail.com'],	
		['Jose', 0, 'josemmavarez@gmail.com'],
		['Dario', 0, 'comercial@datalabcenter.com'],
		['Pedro', 0, 'pedro@datalabcenter.com'],
		['Luciano', 0, 'luciano@datalabcenter.com'],
		['Willian', 0, 'willian@datalabcenter.com'],
	];
}
